...
function AboutUs(){
    return(
        <section className='aboutUs'>
            ...
            <div id="Rafid-int" className="mental-cat">
                <h1>Rafid Zia</h1>
            ...
            <div id="Bilal-int" className="mental-cat">
                <h1>Bilal Qaiser</h1>
            ...
            <div id="Shahriar-int" className="mental-cat">
            ...
            <div id="end-message" className="cat-city"/>
